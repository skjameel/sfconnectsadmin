...
import {
    getTeacherDetails, updateTeacher
} from './actions';
import {
    SchoolList
} from '../school/actions';
...
class Edit extends React.Component {
    ...
    componentWillMount() {
        ...
        const queryparams = {
            customizeQuery: `select * from teacher where Id=${this.props.match.params.id}`,
        };
        this.props.getTeacherDetails(this.props.match.params.id, queryparams).then(res => {
            ...
            this.props.form.setFieldsValue({ SubjectId: data.SubjectId })
        });
    }
    ...
    handleSubmit = e => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                const { Firstname, Lastname, SchoolId,SubjectId, Isactive, createdBy } = values;
                ...
                this.props.updateTeacher(this.props.match.params.id, queryparams).then(res => {
                    const { value: { success, data } } = res;
